...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_chinese_output_script_setting,
            shortcut::change_cantonese_output_style_setting,
            ...
            shortcut::change_strict_offline_mode_setting,
            ...
            shortcut::change_append_terminal_period_setting,
