...
#[tauri::command]
#[specta::specta]
pub fn change_chinese_output_script_setting(
    app: AppHandle,
    output_script: crate::settings::ChineseOutputScript,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.chinese_output_script = output_script;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_cantonese_output_style_setting(
    app: AppHandle,
    output_style: crate::settings::CantoneseOutputStyle,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.cantonese_output_style = output_style;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_strict_offline_mode_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.strict_offline_mode = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_append_terminal_period_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.append_terminal_period = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
