...
import { AppendTerminalPeriod } from "../AppendTerminalPeriod";
import { OfflinePrivacyMode } from "../OfflinePrivacyMode";
  ...
  return (
    <div className="max-w-3xl w-full mx-auto space-y-6">
      <SettingsGroup title={t("settings.advanced.groups.app")}>
        ...
        <OfflinePrivacyMode descriptionMode="tooltip" grouped={true} />
      ...
      <SettingsGroup title={t("settings.advanced.groups.output")}>
        ...
        <AppendTerminalPeriod descriptionMode="tooltip" grouped={true} />
      </SettingsGroup>
