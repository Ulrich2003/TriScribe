...
const settingUpdaters: {
  ...
  chinese_output_script: (value) =>
    commands.changeChineseOutputScriptSetting(
      value as "simplified" | "traditional",
    ),
  cantonese_output_style: (value) =>
    commands.changeCantoneseOutputStyleSetting(value as "spoken" | "written"),
  ...
  strict_offline_mode: (value) =>
    commands.changeStrictOfflineModeSetting(value as boolean),
  ...
  append_terminal_period: (value) =>
    commands.changeAppendTerminalPeriodSetting(value as boolean),
